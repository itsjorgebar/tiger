...
fun yyAction42 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (Tokens.INT((revfold (fn(a,r)=>ord(a)-ord("0")+10*r) (explode yytext) 0),yyyypos, yypos+size(yytext)))
      end
fun yyAction43 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (yytext, Tokens.ID(yypos, yypos+size(yytext)))
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"o"
              ...
              then if inp = #"b"
                  ...
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ37(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp = #"{"
              then yyQ37(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp < #"{"
              then if inp = #"u"
        ...
        | SOME(inp, strm') =>
            if inp = #"p"
              ...
              then if inp = #"s"
                  ...
                  then if inp = #"q"
                      then yyAction43(strm, yyNO_MATCH)
                      else yyQ73(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                else if inp = #"u"
                  then yyQ37(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                  else yyAction43(strm, yyNO_MATCH)
            else if inp = #"|"
        ...
        | SOME(inp, strm') =>
            if inp = #"p"
              ...
              then if inp = #"s"
                  ...
                  then if inp = #"q"
                      then yyAction43(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                else if inp = #"u"
                  then yyQ37(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                  else yyAction43(strm, yyNO_MATCH)
            else if inp = #"|"
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ82(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
       ...
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              else yyQ86(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
      (* end case *))
