        ...
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp = #"."
                  ...
                  then yyAction17(strm, yyNO_MATCH)
                  else yyQ38(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp = #"["
              then yyAction17(strm, yyNO_MATCH)
            else if inp < #"["
              then if inp <= #"@"
        ...
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp = #"."
                  ...
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ38(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp = #"["
              then yyAction18(strm, yyNO_MATCH)
            else if inp < #"["
              then if inp <= #"@"
...
fun yyQ19 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ82(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              else yyQ87(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
      (* end case *))
